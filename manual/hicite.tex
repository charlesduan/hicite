...
\DescribeMacro\sepforlistloop\marg{handler} \marg{2sep}\marg{3mid}\marg{3last}
\marg{list}
...
\DescribeMacro\sepdolistloop \marg{2sep}\marg{3mid}\marg{3last} \marg{list}

Executes the macro |\do| on each element of the list and adds separators.

\DescribeMacro\sepforlistcsloop \meta{handler}
...
\DescribeMacro\sepdolistcsloop \marg{2sep}\marg{3mid}\marg{3last} \marg{listcs}
