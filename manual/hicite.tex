...
\section{Example Reference Definitions}

The following are a few items from my personal archives that may help to
illustrate a variety of reference definitions.
...
An unreported, per curiam, \emph{In re} case:
\begin{demo}
\begin{verbatim}
\defcase{nimitz}{
...
An administrative decision with subsequent history, using a shortened definition
form:
\begin{demo}
\begin{verbatim}
\ExplanatoryPhrase{affirmed without opinion,}
\defadmincase{biodelivery}{
BioDelivery Sciences International, Inc. v. RB Pharmaceuticals Ltd.,
No. IPR2014-00325 (P.T.A.B. jun 30, 2015);
slip,
...
A document in a case, where the case has been defined as an anonymous reference
(see \sec{anonymous}):
\begin{demo}
\begin{verbatim}
\defcasedoc{wyze}{
citation=case: {
    parties={Wyze Labs, Inc. v. Beijing Rockrobo Technology Co.},
    docket=2:21-cv-941,
    court=W.D. Wash.,
...
\subsection{Constitutions and Statutes}

A named clause of the Constitution:
\begin{demo}
\begin{verbatim}
\defconst{a2s3}{
...
Several U.S. Code statutes (these may be cited using |\inline{101}| or such):
\begin{demo}
\begin{verbatim}
\defcitegroup\defstatcode{35 U.S.C. S }{101, 102, 103, 112, 271}
\end{verbatim}
\end{demo}

A named statute with an original section number:
\begin{demo}
\begin{verbatim}
\defstatcode{337}{
...
A session law, with a short name:
\begin{demo}
\begin{verbatim}
\defstatsess{nttaa}{
...
\subsection{Legislative and Administrative Materials}
