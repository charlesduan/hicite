...
%% src/legacy.dtx  (with options: `test')
...
%% src/histrings.dtx  (with options: `test')
%% src/hiabbrev.dtx  (with options: `test')
%% src/hisort.dtx  (with options: `test')
...
\subsection{Undefining Parameters}

\AssertExpand{\hi@param@gobble\hi@kv@name}{\detokenize{name}}

\begingroup
    \hi@undefine\hi@kv@journal
    \AssertMacro\hi@kv@journal{\hi@param@undef{\hi@param@gobble\hi@kv@journal}}%

    \let\emsg\relax
    \def\@this@case{test}
    \def\PackageError#1#2#3{#2}%
    \AssertBox{\hi@kv@journal}{Citation parameter journal missing in test}

    \advance\hi@citelevel\@ne
    \AssertBox{\hi@kv@journal}{Citation parameter journal missing in
    test\textbf{???}}
\endgroup
...
\AssertBox{\hi@signals@withfont{see also}}{\emph{see also}}
\AssertBox{\hi@signals@withfont{see, e.g.,}}{\emph{see, e.g.},}
...
\AssertExpand{\hi@fmt@pageno{15}}{15}
\AssertExpand{\hi@fmt@pageno{15,,,}}{15}
\AssertExpand{\hi@fmt@pageno{15, 20}}{15, 20}
\AssertExpand{\hi@fmt@pageno{15,,, 20}}{15, 20}
\AssertExpand{\hi@fmt@pageno{15-20, 25-30}}{15--20, 25--30}
\AssertExpand{\hi@fmt@pageno{115-120, 1425-1530}}{115--20, 1425--530}
\AssertExpand{\hi@fmt@pageno{paragraph 15}}{para.~15}
\AssertExpand{\hi@fmt@pageno{paragraphs 15}}{para.~15}
\AssertExpand{\hi@fmt@pageno{paragraph 15-20}}{paras.~15--20}
\AssertExpand{\hi@fmt@pageno{paragraph 15, 20}}{paras.~15, 20}
\AssertExpand{\hi@fmt@pageno{paragraph 15, at 25-30}}{para.~15, at 25--30}
\AssertExpand{\hi@fmt@pageno{paragraph 15/a1}}
    {para.~15(a)\hi@psize@penalty(1)}
\AssertExpand{\hi@fmt@pageno{paragraph 15/a1, /a2}}
    {para.~15(a)\hi@psize@penalty(1), (a)\hi@psize@penalty(2)}
\AssertExpand{\hi@fmt@pageno{paragraph 15/a1-/2}}
    {para.~15(a)\hi@psize@penalty(1)--(2)}
\AssertExpand{\hi@fmt@pageno{paragraph 15/a1, /a2-/3}}
    {para.~15(a)\hi@psize@penalty(1), (a)\hi@psize@penalty(2)--(3)}
\AssertExpand{\hi@fmt@pageno{paragraph 15, table 4-5, at 36}}
    {para.~15, tbls.4--5, at 36}
\AssertExpand{\hi@fmt@pageno{15 note 6}}{15 n.6}
\AssertExpand{\hi@fmt@pageno{15 note 5, 6, 7}}{15 nn.5, 6 \& 7}
\AssertExpand{\hi@fmt@pageno{15 & note 5, 6, 7}}{15 \& nn.5, 6 \& 7}
\AssertExpand{\hi@fmt@pageno{S 5-6}}{\textsection\textsection~5--6}
\AssertExpand{\hi@fmt@pageno{P 5-6}}{\textparagraph\textparagraph~5--6}
\AssertExpand{\hi@fmt@pageno{-34/a}}{34(a)}
\AssertExpand{\hi@fmt@pageno{!A5}}{\hi@pgnum@raw A5}
\AssertExpand{\hi@fmt@pageno{*123-125}}{*123--25}
...
\hi@fpg@defsegment{foo}
\hi@fpg@defsegment{bar}

\AssertExpand{\hi@fpg@segment{15}{foo}{\@iden}{missing}}{missing}
\AssertExpand{\hi@fpg@segment{15 ::bar: 7}{foo}{\@iden}{missing}}{missing}
\AssertExpand{\hi@fpg@segment{15 ::foo: 24}{foo}{\@iden}{fail}}{24}
\AssertExpand{\hi@fpg@segment{15 ::foo: 24 ::bar: 7}{foo}{\@iden}{fail}}{24}
\AssertExpand{\hi@fpg@segment{15 ::foo: 24 ::bar: 7}{bar}{\@iden}{fail}}{7}

\def\@this@orig@page{15 ::foo: 24 ::bar: 7}
\AssertExpand{\hi@fpg@orig@page@segment{foo}{\@iden}{fail}}{24}

\let\@this@orig@page\relax
\AssertExpand{\hi@fpg@orig@page@segment{foo}{\@iden}{missing}}{missing}
...
\begingroup
    ...
    \let\HiTOAPassimNum\tw@
    \AssertCallback{\hi@toa@usepg{ref}}{\HiTOAPassim}

    \let\HiTOAPassimNum\thr@@
    \AssertCallback{\hi@toa@usepg{ref}}{\HiTOAPassim}

    \chardef\HiTOAPassimNum=4
    \AssertCallback{\hi@toa@usepg{ref}}{ii--iv, 4--5, 7}
\endgroup
...
\HiNewTOACat{movie}{m}{Motion Picture/s}{Y}
\HiDefaultTOACat{film}{movie}
...
\AssertBox{\note{us-v-craft}}{%
    \InFootnote{United States v.\ Craft, 535 U.S. 274 (2002).}%
}

\defcase{berge-v-board}{
parties=United States ex rel. Berge v. Board of Trustees,
cite=104 F.3d 1453,
court=4th Cir.,
year=1997,
}
...
\AssertBox{\note{berge-v-board}}{%
    \InFootnote{%
        United States \emph{ex rel.}\ Berge v.\ Bd.\ of Trs., 104 F.3d 1453 (4th
        Cir.\ 1997).%
    }%
}
...
\AssertBox{\inline{271}}{35 U.S.C. \S~271}

\AssertBox{\note{271 at /b}}{%
    \InFootnote{35 \textsc{U.S.C.} \textsection~271(b).}%
}

\defstatcode{273}{35 U.S.C. S 273}

\AssertBox{\Inline{273}}{Section 273 of title 35 of the U.S. Code}
...
\defstatsess{caa}{
name=Clayton Antitrust Act of 1914,
chapter=323,
cite=38 Stat. 730,
year=1914,
}
\AssertBox{\footnote{\inline{caa}. \sentence{caa}.}}{\InFootnote{the Clayton
Antitrust Act of 1914. Ch.\ 323, 38 \textsc{Stat.}\ 730.}}

\subsection{Model Code Parenthetical}
...
\begingroup
    ...
    \hi@modelcode@makedateparen
    \AssertMacro{\hi@modelcode@dateparen}{2000}
...
\begingroup
    ...
    \hi@param@set{other}{%
        year=2000,
        instauth=American Law Institute,
    }
    \hi@modelcode@makedateparen
    \AssertMacro\hi@modelcode@dateparen{\hi@fn@bookauthor{Am. L. Inst.} 2000}
\endgroup
...
\begingroup
    ...
    \hi@param@set{other}{%
        year=2000,
        instauth=American Law Institute,
        edition=Proposed Official Draft,
    }
    \hi@modelcode@makedateparen
    \AssertMacro\hi@modelcode@dateparen{\hi@fn@bookauthor{Am. L. Inst.},
    Proposed Official Draft 2000}
\endgroup
...
\begingroup
    ...
    \hi@param@set{other}{%
        year=2000,
        instauth=American Law Institute,
        edition=Tentative Draft No. 17,
    }
    \hi@modelcode@makedateparen
    \AssertMacro\hi@modelcode@dateparen{\hi@fn@bookauthor{Am. L. Inst.},
    Tentative Draft No. 17, 2000}
...
\AssertBox{\note{ali at S 847A}}{\InFootnote{\textsc{Restatement (Second) of
Torts} \S~847A (\textsc{Am.~L.~Inst.}, Tentative Draft No.~17, 2000).}}

\AssertBox{\note{ali at S 847A}}{\InFootnote{\emph{Id.}}}

\AssertBox{\note{ali at S 848}}{\InFootnote{\textsc{Restatement (Second) of
Torts} \S~848.}}

\subsection{Contained Session Laws}

\defstatsess{dmca-sess}{
name={Digital Millennium Copyright Act},
publiclaw={105-304},
cite={112 Stat. 2860},
year={1998}
...
\defstatsess{ocilla}{
name={Online Copyright Infringement Liability Limitation Act},
page=2877,
in=dmca-sess,
origsect=title II,
inline=OCILLA,
...
\AssertBox{\note{ocilla}}{\InFootnote{Online Copyright Infringement Liability
Limitation Act (OCILLA), \emph{in} Digital Millennium Copyright Act, Pub.~L.
No.~105-304, tit.~II, 112 \textsc{Stat.}~2860, 2877 (1998).}}

\HiFullCite{ocilla}
\HiFullCite{dmca-sess}

\AssertBox{\note{ocilla at S 203 ::stat: 2886}}{\InFootnote{Online Copyright
Infringement Liability Limitation Act (OCILLA) \S~203, \emph{in} Digital
Millennium Copyright Act, Pub.~L. No.~105-304, tit.~II, 112
\textsc{Stat.}~2860, 2886 (1998).}}

\HiNoId

\AssertBox{\note{ocilla}}{\InFootnote{OCILLA, 112 \textsc{Stat.}~at 2877.}}
\HiNoId

\AssertBox{\note{ocilla at S 204 ::stat: 2887}}{\InFootnote{OCILLA
\S~204, 112 \textsc{Stat.}~at 2887.}}

\AssertBox{\note{ocilla}}{\InFootnote{\emph{Id.}, 112 \textsc{Stat.}~at 2877.}}

\AssertBox{\note{ocilla at S 204 ::stat: 2887}}{\InFootnote{\emph{Id.}~\S~204,
112 \textsc{Stat.}~at 2887.}}

\AssertBox{\note{ocilla at S 204 ::stat: 2887}}{\InFootnote{\emph{Id.}}}

\AssertBox{\inline{ocilla}}{the Online Copyright Infringement Liability
Limitation Act (``OCILLA'')}

\AssertBox{\inline{ocilla at S 203}}{\S~203 of OCILLA}

\HiFullCite{ocilla}

\AssertBox{\inline{dmca-sess}\note{ocilla at S 203 ::stat: 2886}}{the Digital
Millennium Copyright Act\InFootnote{Online Copyright
Infringement Liability Limitation Act (OCILLA) \S~203,
\emph{in} Digital Millennium Copyright Act, Pub.~L. No.~105-304, tit.~II, 112
\textsc{Stat.}~2860, 2886 (1998).}}
...
\AssertBox{\note{yoda-2015}}{\InFootnote{%
    You Own Devices Act, H.R. 862, 114th Cong.\ (Feb.\ 11, 2015).%
}}

\defbill{mapia}{
name=Medication Affordability and Patient Integrity Act,
inline=MAPIA,
number=S. 2658,
date=june 17 2026,
congress=119,
status={reported by Senate Health, Education, Labor and Pensions Committee},
}

\AssertBox{\inline{mapia}}{%
the Medication Affordability and Patient Integrity Act (``MAPIA'')%
}

\AssertBox{\note{mapia}}{\InFootnote{%
Medication Affordability and Patient Integrity Act (MAPIA),
S. 2658, 119th
Cong.\ (as reported by S. Health, Education, Labor \& Pensions Comm., June 17,
2026).%
}}

\AssertBox{\inline{mapia}}{MAPIA}

\HiNoId

\AssertBox{\note{mapia at S 1}}{\InFootnote{%
S. 2658, \textsection~1.%
}}

\defcongdoc{oda-report}{
name=Orphan Drug Act,
date=1982,
number=H.R. Rep. No. 97-840,
}

\AssertBox{\note{oda-report at 5}}{\InFootnote{%
\textsc{Orphan Drug Act}, \textsc{H.R. Rep.\ No.\ 97-840}, at 5 (1982).%
}}

\defhearing{azar-hearing}{
name=Nomination of Alex Azar to Serve as Secretary of Health and Human Services,
committee={Senate Committee on Health, Education, Labor and Pensions},
congress=115,
date=nov 29 2017,
}

\AssertBox{\note{azar-hearing}}{\InFootnote{%
...
\begingroup
    ...
    \abbrevtest{abc delete def}{abc def}
    \abbrevtest{abc delete}{abc}
    \abbrevtest{delete def}{def}
    \abbrevtest{delete}{}
    \abbrevtest{a delete-fail}{a delete-fail}
    \abbrevtest{a-delete fail}{a-delete fail}
    \abbrevtest{Really Big delete Company}{R.B. Co.}
    \abbrevtest{Really Big delete-Company}{R.B. delete-Co.}
\endgroup
